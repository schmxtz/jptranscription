...
GERMAN_IPA_TO_KATAKANA_MAP = {
    ...
    '\u0254': '\u30AA',  # ɔ -> オ (word: "Oktober", ipa: in "ɔkˈtoːbɐ")
    '\u0075': '\u30A6',  # u -> ウ (word: "Uhr", ipa: in "uːɐ̯")
    '\u028A': '\u30A6',  # ʊ -> ウ (word: "und", ipa: in "ʊnt")
    '\u0153': '\u30AA\u30A7',  # œ -> オェ (word: "öffnen", ipa: in "ˈœfnən")
    '\u00F8': '\u30AA\u30A7',  # ø -> オェ (word: "Ökologie", ipa: in "ˌøkoloˈɡiː")
    '\u0061\u02D0\u0250\u032F': '\u30A2\u30FC',  # aːɐ̯  -> アー (word: "Januar", ipa: in "ˈjanuaːɐ̯")
